...
<div class="review-help"><p>Click a node to select it; click its sole selection again or press F2 to edit. Enter adds a sibling, Shift+Enter adds one before it, Tab adds a child, and Shift+Tab inserts a parent. At the root, Shift+Tab adds a left branch. Enter commits; Shift+Enter adds a line; Escape cancels.</p>
