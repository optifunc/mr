...
- `pnpm perf`: Chromium early workload diagnostic, writes JSON samples and a
  screenshot under `docs/evidence/milestone-a/`.
...
entire 1372px-wide comparison is visible. Device scale is 1; widget zoom is 100%.
The comparison-only mount translates its root to (238,159) to align with the
supplied image displayed at 60%; normal mounts retain centered roots.
...
[the milestone A report](evidence/milestone-a/report.md). `checks.txt` and
